...
const FloatingSocials = () => {
  ...
  return (
    ...
    >
      ...
      <a href="https://zalo.me/0869529304" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-bg-glass backdrop-blur-md border border-glass flex items-center justify-center text-text-secondary transition-all duration-300 hover:bg-[#0068FF] hover:text-white hover:border-[#0068FF] shadow-[0_4px_15px_rgba(0,0,0,0.3)] hover:shadow-[0_0_15px_rgba(0,104,255,0.5)] font-bold text-sm" aria-label="Zalo">
        Zalo
      </a>
    </div>
  );
