...
const FloatingSocials = () => {
  ...
  // Prevent chatbot panel from causing page zoom on mobile
  useEffect(() => {
    ...
    <>
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-none">
        ...
        <button
          ...
          onMouseEnter={handleChatHover}
          onMouseLeave={handleChatLeave}
          className={`chatbot-fab-btn pointer-events-auto ${isChatOpen ? 'chatbot-fab-active' : ''}`}
        ...
        {/* Social buttons - HIDES ON FOOTER */}
        <div 
