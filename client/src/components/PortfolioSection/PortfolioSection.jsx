    ...
    <section id="portfolio" className="py-[100px] bg-bg-main">
      <div className="container-custom">
        ...
        <div className="text-center mt-10">
          <button className="inline-block px-8 py-3 border border-accent text-accent rounded-full font-medium transition-all duration-200 hover:bg-accent hover:text-bg-main">Xem toàn bộ dự án</button>
        </div>
      </div>
