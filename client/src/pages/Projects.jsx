...
const Projects = () => {
  ...
  const defaultData = [
    { _id: 1, title: 'Summer Vibe', category: 'Beauty', location: 'Studio', coverImage: 'https://images.unsplash.com/photo-1512413914619-14a87a6078ac?w=500&auto=format&fit=crop', images: ['https://images.unsplash.com/photo-1512413914619-14a87a6078ac?w=1200'] },
    ...
    { _id: 6, title: 'Dark Academia', category: 'Fashion', location: 'Sài Gòn', coverImage: 'https://images.unsplash.com/photo-1509631179647-0c9528c6ea40?w=500&auto=format&fit=crop', images: ['https://images.unsplash.com/photo-1509631179647-0c9528c6ea40?w=1200'] },
  ];
    ...
    <div className="pt-[120px] pb-[100px] bg-bg-main min-h-screen">
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          <Link to="/" className="text-accent hover:underline mb-4 inline-block">&larr; Trở về Trang chủ</Link>
          <h1 className="text-[40px] md:text-[50px] mb-4 text-white font-secondary">Toàn bộ Dự án</h1>
          <p className="text-text-secondary max-w-[600px] mx-auto">Tất cả những dự án, những khoảnh khắc nghệ thuật được thực hiện tỉ mỉ và tâm huyết nhất.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredData.map(item => (
            <div key={item._id} className="group relative rounded-lg overflow-hidden cursor-pointer bg-bg-glass border border-glass">
              <img 
